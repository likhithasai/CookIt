...
public class NextStepHandler implements RequestHandler {
    ...
    static{
    		...
    		recipes.put("Cheese Sandwich", new String[]{"<speak> Let's make a cheese sandwich today then. Are you ready? <break time='2s'/> Get two slices of bread </speak>", "<speak> Spread butter on the bread </speak>" ," <speak> Slice the correct amount of cheese for your sandwich </speak>","<speak> Place the cheese on the buttered bread </speak>", "<speak> Place the two sides of bread together </speak>"});
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        if (step >= no_steps){
        	speechText = "<speak> Bon appetit.<amazon:effect name='whispered'> I'll be watching you. </amazon:effect></speak>";
        }
        else{
